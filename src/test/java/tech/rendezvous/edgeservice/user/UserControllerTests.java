package tech.rendezvous.edgeservice.user;
...
import tech.rendezvous.edgeservice.config.SecurityConfig;
...
public class UserControllerTests {
    ...
    void whenAuthenticatedThenReturnUser() {
        var expectedUser = new User("jon.snow", "Jon", "Snow", List.of("administrator", "user"));
