package tech.rendezvous.edgeservice.config;
...
public class SecurityConfigTests {
    ...
    private ClientRegistration testClientRegistration() {
        return ClientRegistration.withRegistrationId("test")
                ...
                .clientId("test")
                .authorizationUri("https://sso.rendezvous.tech/auth")
                .tokenUri("https://sso.rendezvous.tech/token")
                .redirectUri("https://rendezvous.tech")
                .build();
    }
}
